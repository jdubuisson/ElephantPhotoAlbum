...
class MyAlbumController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ElephantAlbumBundle:MyAlbum:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("ElephantAlbumBundle:MyAlbum:edit.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("ElephantAlbumBundle:MyAlbum:share.html.twig")
     */
